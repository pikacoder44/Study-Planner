      ...
      <div className="grid gap-4 lg:grid-cols-[0.7fr_1.3fr]">
        <Card className="p-5">
          ...
          <div className="mt-6 border-t border-[var(--border)] pt-5">
            <p className="text-sm text-[var(--muted)]">Total focused time</p>
        ...
        <div className="space-y-3">
          {studySessions.map((session) => (
            <Card key={session.id} className="flex items-center gap-4 p-4">
              <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-[#e8eff1] text-[var(--accent)]">
                <Clock3 size={19} />
              </span>
